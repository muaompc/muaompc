"""Generate Matlab interface for C code to solve a problem using the FGM"""
...
class MatlabCodeGenerator(CCG, object):
    ...
    def _generate_matlab_code(self):
        ...
        self._replace_prefix('fgmmatlab.c', srcdir='matlab', destdir='matlab')
        self._replace_prefix('fgmmatlab.h', srcdir='matlab', destdir=include_path)
